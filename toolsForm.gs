...
function refHighlights (input)
{
  ...
  .replace(/\b((?:short|long|evoked|unitary|spontaneous|miniature|quantal|photo|electr(?:o|ical))[^<>)(]{0,1}){0,1}([esmu]{0,1}\.{0,1}[ei]\.{0,1}p\.{0,1}s\.{0,1}[cp]\d*|unitary|AMPA|NMDA|GABA[^<>)(]{0,1}(?:A|B)*|suppress|feed.{0,1}back|feed.{0,1}forward|inhibit|excit|glutamat|paired(?!.{0,1}pulse|.{0,1}t.test)|simultaneous|coupl|Reciprocal|stimul|facilit|depress|STDP|LT[PD]|potentiat|plasticity|term|n=\d+|first|second|third|zero|one|two|three|four|five|fifth|six|seven|eight|nine|ten|eleven|twelve|twenty|thirty|fourty|fifty|sixty|seventy|eighty|ninty|hundred*|thousand*)(ergic|atory|[at]*ion|[at]*ing|ory|ated*|us|ly|ed|th|[es]{0,2}){0,1}([^<>)(]{0,1}(?:recording|[AB](?= ))){0,1}\b/ig,
           "<mark style='background-color:rgba(255,128,171,0.5); color:black;'>$1$2$3$4</mark>")         //pink
  .replace(/([\s(;,=])([-+∼≤≥≈]{0,1}\d+\.{0,1}\d*[-+±]{0,1}\d*\.{0,1}\d*)([^<>)(]{0,1}(?:pairs*|.{0,1}Ω|[µμ].{0,1}|°C|m[MVs]|m[lL].{0,1}min|[pn][ASF]|Hz|%)*){0,1}([^<>)(]{0,1}(?:out of|before,* and|and|to|or|of)[^<>)(]){0,1}([-+∼≤≥≈]{0,1}\d+\.{0,1}\d*[-+±]{0,1}\d*\.{0,1}\d*){0,1}([^<>)(]){0,1}(?!nAChR*)(%|Hz|°C|.{0,1}Ω|[µμ].{0,1}|m[Vs]|m[lL].min|[pn][ASC]|cells*|neurons*|pairs*|quantal*)/g,
