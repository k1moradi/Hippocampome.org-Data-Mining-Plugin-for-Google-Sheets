...
- a **Check Query Tool**: to access a potential connection search engine hosted by hippocampome.org. This search engine gets morphology, marker, membrane electrophysiology and firing pattern of presynaptic and postsynaptic neurons and generates a list of potential connections. While generating this list, we exclude potential connections that are already refuted by hippocampome.org.
